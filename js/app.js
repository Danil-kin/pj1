(() => {
    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            spollerTitle.parentNode.classList.toggle("_spoller-open");
                ...
                function hideSpollersBody(spollersBlock) {
                    ...
                    if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        spollerActiveTitle.parentNode.classList.remove("_spoller-open");
        ...
        function showMore() {
            window.addEventListener("load", (function(e) {
                ...
                function getOriginalHeight(showMoreContent) {
                    let parentHidden;
                    let hiddenHeight = showMoreContent.offsettHeight;
        ...
        window.addEventListener("load", (function(e) {
            if (document.querySelector(".item-dish__block")) {
                const itemBlog = document.querySelector(".item-dish__block");
                const copyItemBlog = itemBlog.cloneNode(true);
                const latestPost = document.querySelector(".latest-post");
                latestPost.appendChild(copyItemBlog);
            }
            if (document.querySelector(".blog__content")) {
                const countIdAll = document.getElementsByClassName("blog__item").length;
                const countIdCocktails = document.getElementsByClassName("cocktails").length;
                const countIdFish = document.getElementsByClassName("fish").length;
                const countIdMeat = document.getElementsByClassName("meat").length;
                const counterAll = document.getElementById("allValue");
                const counterCocktails = document.getElementById("cocktailsValue");
                const counterFish = document.getElementById("fishValue");
                const counterMeat = document.getElementById("meatValue");
                counterAll.innerHTML = countIdAll;
                counterCocktails.innerHTML = countIdCocktails;
                counterFish.innerHTML = countIdFish;
                counterMeat.innerHTML = countIdMeat;
            }
            if (document.querySelector(".our-chefs__body")) {
                const chefPhoto = document.querySelectorAll(".item-our-chefs__photo");
                const chefName = document.querySelectorAll(".our-chefs__header");
                chefPhoto.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".item-our-chefs");
            ...
            if (document.querySelectorAll(".video-module")) if (document.querySelector("video")) {
                const videoModule = document.querySelector(".video-module");
                videoModule.addEventListener("click", (function(e) {
                    if (document.querySelector(".video-module").querySelector("video").paused) {
                        document.querySelector(".video-module").classList.add("_playvideo");
                        ...
                        document.querySelector(".video-module").classList.remove("_playvideo");
                    }
                }));
            }
            if (document.querySelector("[data-calendar]")) {
                datepicker_min("[data-calendar]", {
                    ...
                    overlayButton: "Chose",
                    overlayPlaceholder: "Write the year",
                    dateSelected: new Date
                });
            }
            if (document.querySelector(".comment-blog__comments")) {
                const comments = document.querySelectorAll(".comment-blog__comment").length;
                const commentValue = document.querySelector(".comment-blog__title-value");
                commentValue.innerHTML = comments;
            }
            if (document.querySelector(".comment-blog__comment")) {
                const replyBtn = document.querySelectorAll(".comment__btn");
                document.querySelector(".comment-blog__comment");
                const authorName = document.querySelector(".answer-comment__name-box");
                const cancelBtn = document.querySelector(".answer-comment__btn");
                replyBtn.forEach((element => {
                    element.addEventListener("click", (function(e) {
                        e.target.closest(".comment-blog__container").classList.add("reply");
                        let respondName = e.target.previousElementSibling.querySelector(".comment__name").innerHTML;
                        authorName.innerHTML = respondName;
                    }));
                }));
                cancelBtn.addEventListener("click", (function(e) {
                    document.querySelector(".comment-blog__container").classList.remove("reply");
                }));
            }
        }));
        function mapAdd() {
